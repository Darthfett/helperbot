...
function inject(bot) {
  ...
  function increaseY() {
    ...
    if (!bot.entity.onGround) {
      console.log("increaseY - we're falling. just wait.");
  ...
  function breakBlock(targetBlock, newState) {
    if (! bot.canDigBlock(targetBlock)) {
      ...
      console.log("bumped into undiggable block; moving randomly to get better angle");
